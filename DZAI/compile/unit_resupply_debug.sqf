...
*/
private["_unit","_currentWeapon","_weaponMagazine","_nearbyZeds","_marker","_markername","_lastBandage","_bandages","_unitGroup","_health","_needsHeal","_unitWeapons","_unitMagazines","_weapongrade"];
